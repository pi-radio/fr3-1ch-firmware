...
#define TRACER_EMB_RX_PIN                            LL_GPIO_PIN_15
...
#define TRACER_EMB_TX_DMA_CHANNEL                    LL_DMA_CHANNEL_1
#define TRACER_EMB_ENABLECHANNEL                     LL_DMA_ResumeChannel
#define TRACER_EMB_DISABLECHANNEL                    LL_DMA_SuspendChannel
#define TRACER_EMB_TX_DMA_IRQ                        GPDMA1_Channel1_IRQn
#define TRACER_EMB_TX_DMA_IRQHANDLER                 GPDMA1_Channel1_IRQHandler
