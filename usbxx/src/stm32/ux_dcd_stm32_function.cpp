...
UX_DCD_STM32     *dcd_stm32;
    ...
    case UX_DCD_TRANSFER_ABORT:
        status = _ux_dcd_stm32_transfer_abort(dcd_stm32, (UX_SLAVE_TRANSFER *)parameter);
        break;

    case UX_DCD_CREATE_ENDPOINT:

        status =  _ux_dcd_stm32_endpoint_create(dcd_stm32, (UX_SLAVE_ENDPOINT *)parameter);
        break;

    case UX_DCD_DESTROY_ENDPOINT:

        status =  _ux_dcd_stm32_endpoint_destroy(dcd_stm32, (UX_SLAVE_ENDPOINT *)parameter);
        break;

    case UX_DCD_RESET_ENDPOINT:

        status =  _ux_dcd_stm32_endpoint_reset(dcd_stm32, (UX_SLAVE_ENDPOINT *)parameter);
        break;

    case UX_DCD_STALL_ENDPOINT:

        status =  _ux_dcd_stm32_endpoint_stall(dcd_stm32, (UX_SLAVE_ENDPOINT *)parameter);
        break;
