...
#define UCPDDMA_INSTANCE0_LL_CHANNEL_RX   LL_DMA_CHANNEL_6

#define UCPDDMA_INSTANCE0_CHANNEL_RX   GPDMA1_Channel6
...
#define UCPDDMA_INSTANCE0_LL_CHANNEL_TX   LL_DMA_CHANNEL_7

#define UCPDDMA_INSTANCE0_CHANNEL_TX   GPDMA1_Channel7
