...
void SystemInit(void)
{
  ...
  uint32_t *pin = &_sidata;
  uint32_t *pout = &_sdata;
...
system::system(int fhse) : sysclk({ &hse, /* pll1, */ &hsi, &csi }),
    hse(fhse)
{
...
bool hsi_clock::ready()
{

}

uint32_t hsi_clock::divider(void)
{
}

void hsi_clock::set_divider(uint32_t n)
{
